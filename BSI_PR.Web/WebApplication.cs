...
namespace BSI_PR.Web {
    ...
    public partial class BSI_PRAspNetApplication : WebApplication {
        private DevExpress.ExpressApp.SystemModule.SystemModule module1;
        private DevExpress.ExpressApp.Web.SystemModule.SystemAspNetModule module2;
        private BSI_PR.Module.BSI_PRModule module3;
        private BSI_PR.Module.Web.BSI_PRAspNetModule module4;
        ...
        static BSI_PRAspNetApplication() {
        ...
        #endregion
        public BSI_PRAspNetApplication() {
            InitializeComponent();
			InitializeDefaults();
        }
        ...
        private void BSI_PRAspNetApplication_DatabaseVersionMismatch(object sender, DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
        ...
        private void InitializeComponent() {
            ...
            this.module4 = new BSI_PR.Module.Web.BSI_PRAspNetModule();
            ...
            this.securityStrategyComplex1.UserType = typeof(BSI_PR.Module.BusinessObjects.SystemUsers);
            // 
            ...
            this.DatabaseVersionMismatch += new System.EventHandler<DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs>(this.BSI_PRAspNetApplication_DatabaseVersionMismatch);
