...
{
    [DefaultClassOptions]
    [Appearance("GoodReturnAttachments1", AppearanceItemType = "Action", TargetItems = "Link", Context = "ListView", Visibility = DevExpress.ExpressApp.Editors.ViewItemVisibility.Hide)]
    [Appearance("GoodReturnAttachments2", AppearanceItemType = "Action", TargetItems = "Unlink", Context = "ListView", Visibility = DevExpress.ExpressApp.Editors.ViewItemVisibility.Hide)]
    ...
    public class GoodsReturnAttachements : FileAttachmentBase
    { // Inherit from a different class to provide a custom primary key, concurrency and deletion behavior, etc. (https://documentation.devexpress.com/eXpressAppFramework/CustomDocument113146.aspx).
        public GoodsReturnAttachements(Session session)
            : base(session)
        {
        }
        ...
        [Association("GoodsReturn-GoodsReturnAttachements")]
