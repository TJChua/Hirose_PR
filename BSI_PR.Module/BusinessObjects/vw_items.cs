...
namespace BSI_PR.Module.BusinessObjects
{
    ...
    [RuleCriteria("itemDeleteRule", DefaultContexts.Delete, "1=0", "Cannot Delete.")]
    // Specify more UI options using a declarative approach (https://documentation.devexpress.com/#eXpressAppFramework/CustomDocument112701).
    public class vw_items : XPLiteObject
    { // Inherit from a different class to provide a custom primary key, concurrency and deletion behavior, etc. (https://documentation.devexpress.com/eXpressAppFramework/CustomDocument113146.aspx).
        public vw_items(Session session)
            : base(session)
        {
        }
        ...
        [XafDisplayName("SAP G/L")]
        [Appearance("ECExepnses", Enabled = false)]
        [Index(13)]
        public string ECExepnses
        {
            get; set;
        }

        [XafDisplayName("ACCTNAME")]
        [Appearance("ACCTNAME", Enabled = false)]
        [Index(15)]
