...
namespace BSI_PR.Module.BusinessObjects
{
    ...
    public class vw_BudgetData : XPLiteObject
    { // Inherit from a different class to provide a custom primary key, concurrency and deletion behavior, etc. (https://documentation.devexpress.com/eXpressAppFramework/CustomDocument113146.aspx).
        public vw_BudgetData(Session session)
            : base(session)
        {
        }
        ...
        [XafDisplayName("Budget Category Code")]
        [Appearance("BudgetCategoryCode", Enabled = false)]
        [Index(5)]
        ...
        [XafDisplayName("Budget Category Name")]
        [Appearance("BudgetCategoryName", Enabled = false)]
        [Index(8)]
        ...
        {
            get { return BudgetCategoryCode + "-" + BudgetCategoryName; }
        }
    }
}