...
namespace BSI_PR.Module.BusinessObjects
{
    ...
    public class vw_POInv : XPLiteObject
    { // Inherit from a different class to provide a custom primary key, concurrency and deletion behavior, etc. (https://documentation.devexpress.com/eXpressAppFramework/CustomDocument113146.aspx).
        public vw_POInv(Session session)
            : base(session)
        {
        }
        ...
        [XafDisplayName("POLine")]
        [Appearance("POLine", Enabled = false)]
        ...
        [XafDisplayName("Depertment")]
        [Appearance("Depertment", Enabled = false)]
        ...
        [Appearance("DocDiscAmount", Enabled = false)]
        [Index(18), VisibleInListView(false), VisibleInDetailView(false), VisibleInLookupListView(false)]
        ...
        [Appearance("DocDiscUnitAmount", Enabled = false)]
        [Index(18), VisibleInListView(false), VisibleInDetailView(false), VisibleInLookupListView(false)]
        ...
        [XafDisplayName("TaxUnitAmount")]
        [Appearance("TaxUnitAmount", Enabled = false)]
        [Index(18), VisibleInListView(false), VisibleInDetailView(false), VisibleInLookupListView(false)]
