...
namespace BSI_PR.Module.Controllers
{
    ...
    public partial class ClosePOController : ViewController
    {
        ...
        public ClosePOController()
        {
            ...
            TargetObjectType = typeof(ClosePO);
        }
        ...
        private void ClosePOController_ViewEditModeChanged(object sender, EventArgs e)
        {
        ...
        protected override void OnDeactivated()
        {
            ...
            {
                ((DetailView)View).ViewEditModeChanged -= ClosePOController_ViewEditModeChanged;
            }
        ...
        private void ClosePO_Execute(object sender, SimpleActionExecuteEventArgs e)
        {
            ...
            {
                ClosePO ClosePO = (ClosePO)View.CurrentObject;
                ...
                try
                {
                    ...
                    if (ClosePO.showAll == true)
                    {

                        doc.Load(HttpContext.Current.Server.MapPath("~\\Reports\\ClosePOAll.rpt"));
                        ...
                        doc.SetParameterValue("CloseDateFrom", ClosePO.DocDate2.ToString("yyyyMMdd"));
                        doc.SetParameterValue("CloseDateTo", ClosePO.DocDate3.ToString("yyyyMMdd"));
                        doc.SetParameterValue("Creator", ClosePO.Creator.Fname.ToString());
                    }
                    else
                    {
                        doc.Load(HttpContext.Current.Server.MapPath("~\\Reports\\ClosePO.rpt"));
                        strServer = GeneralSettings.B1Server;
                        strDatabase = GeneralSettings.B1CompanyDB;
                        strUserID = GeneralSettings.B1DbUserName;
                        strPwd = GeneralSettings.B1DbPassword;
                        ...
                        doc.SetParameterValue("CloseDateFrom", ClosePO.DocDate2.ToString("yyyyMMdd"));
                        doc.SetParameterValue("CloseDateTo", ClosePO.DocDate3.ToString("yyyyMMdd"));
                        doc.SetParameterValue("Department", ClosePO.Department.BoCode.ToString());
                        doc.SetParameterValue("Creator", ClosePO.Creator.Fname.ToString());
                    }
                    ...
                    filename = GeneralSettings.ReportPath.ToString() + GeneralSettings.B1CompanyDB.ToString()
                       + "_ClosePO_" + user.UserName + "_"
                       + DateTime.Parse(ClosePO.DocDate3.ToString()).ToString("yyyyMMdd") + DateTime.Now.ToString("hhmmss") + ".pdf";
            ...
            {
                genCon.showMsg("Fail", "No Close PO Available", InformationType.Error);
            }
        }

        private void ExportExcelClosePO_Execute(object sender, SimpleActionExecuteEventArgs e)
        {
            ...
            if (e.SelectedObjects.Count > 0)
            {
                ...
                try
                {
                    ...
                    filename = GeneralSettings.ReportPath.ToString() + GeneralSettings.B1CompanyDB.ToString()
                       + "_ClosePO_" + user.UserName + "_"
                       + DateTime.Parse(ClosePO.DocDate3.ToString()).ToString("yyyyMMdd") + DateTime.Now.ToString("hhmmss") + ".xls";
